...
ggplot(happy, aes(x=happy)) +geom_bar() #initial view of the distribution before dropping NA's
...
happy_clean
ggplot(happy_clean, aes(x=happy)) + geom_bar() #using the barchart, we can see that the NA column was removed
