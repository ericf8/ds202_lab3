...
ggplot(happy_grouped, aes(finrela, age, fill = happy)) + geom_boxplot() + labs(title = "Distribution of Happiness based on Financial stability and Age, with emphasis on Happiness", x = "Financial Situation", y = "Ages in Years")
